//var backend_url_w2v = "https://chatbot.zapto.org/w2v";
//var backend_url_ont = "https://chatbot.zapto.org/ontology";
//var backend_url_qa = "https://chatbot.zapto.org/qa";
...
function getW2vResponse(text) {
  $.get(backend_url_w2v + "/get", { msg: text }).done(function(data) {
    if (data) {
...
function getOntologyResponse(text) {
  $.get(backend_url_ont + "/get", { msg: text, token: chat_id }).done(function(data) {
    if (data.ask) {
