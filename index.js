...
//var backend_url_ont = "https://lipchat.dumontierlab.com/ontology";
//var backend_url_qa = "https://lipchat.dumontierlab.com/qa";
...
function getOntologyResponse(text) {
  ...
  if (response_counter == '0'){
    ...
    if (lowercaseStr.includes("yes") || lowercaseStr == 'y' || lowercaseStr == 'ya' || lowercaseStr.includes("yeah") || lowercaseStr == 'yep'){
      ...
      $.get(backend_url_ont + "/get", { usage: use, propertyitem: object, actioncost: cost, token: chat_id }).done(function(data) {
        if (data.text){
